...
Shader"test/normala" 
{
    Properties 
    {
        ...
        _TexNr0Power("TexNr0Power" , Range(0,5)) = 0.2
        _TexNr1Power("TexNr1Power" , Range(0,5)) = 0.2
        _TexNr2Power("TexNr2Power" , Range(0,5)) = 0.2
        _TexNr3Power("TexNr3Power" , Range(0,5)) = 0.2
        _TexNr4Power("TexNr4Power" , Range(0,5)) = 0.2
    ...
    SubShader {
        Pass{
            ...
            // float3 NewBlend(float3 lay1, float3 lay2, float4 splat_control)
            // {
            ...
            float4 frag(Interpolators i) : SV_TARGET {
               ...
               half4 blend = Blend(_Tex1Power*lay1.a,_Tex2Power*lay2.a,_Tex3Power*lay3.a,_Tex4Power* lay4.a,_Tex0Power* splat_control);
                // half4 blend = (NewBlend(_Splat0,_Splat1,_Splat2,_Splat3,splat_control),1);
                // o.Alpha = 0.0;
                fixed4 albedo;
				...
				i.normal = normalize(i.normal);
                i.normal = nor1 * blend.r*_TexNr1Power  + nor2 * blend.g*_TexNr2Power  + nor3 * blend.b*_TexNr3Power  + nor4 * blend.a*_TexNr4Power;//法线混合
